...
artwork_sizes %>% 
  ...
  labs(
    ...
    subtitle = "The “coffee strain” plot shows the average areas (width x height) and aspect ratios<br> (width / height) by years of all 2D artworks created between __1545__ and __2012__ which<br> are exhibited by the Tate. Each point represents a year and their sizes scaled by<br> average area value. Their colours are also scaled by an average aspect ratio.<br> Wider aspects are more <span style='color: #cc0000'>___red___</span>, longer aspects are more ___white___ for that year.",
    caption = "\n\n Data by Tate Art Gallery \n Visualization by Botan Ağın"
  ) +
  theme_void() +
  theme(
    legend.position = "none",
    plot.title = element_text(hjust = 0.5, color = "white", family = "Inria Serif", face = "bold", size = 20),
    plot.subtitle = element_markdown(hjust = 0.5, color = "gray80", family = "Inria Serif", size = 10),
    plot.caption = element_text(hjust = 0.5, color = "gray80", family = "Inria Serif", size = 8),
